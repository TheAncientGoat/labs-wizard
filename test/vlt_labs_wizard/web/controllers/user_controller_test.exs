defmodule VltLabsWizard.Web.UserControllerTest do
  use VltLabsWizard.Web.ConnCase

  alias VltLabsWizard.Auth

  @create_attrs %{email: "some email", username: "some username", last_login_at: ~D[2010-04-17], login_count: 42, password: "some password"}
  @update_attrs %{email: "some updated email",  username: "some updated username", last_login_at: ~D[2011-05-18], login_count: 43, password: "some updated password"}
